 ...
 */
public class BengbengtiaoChannelActivity extends BaseChannelActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackground(getResources().getDrawable(R.drawable.channel_bbt_background));
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                new OpenActivityAction(BengbengtiaoChannelActivity.this,
        ...
        final JsonObjectRequest request = new JsonObjectRequest(
                "http://121.201.7.173:8080/wanba_shzg/ott_channel_bbt.jsp",
                null,
    ...
    protected void onBuildHeader(ViewGroup contentView) {
        ...
        headerFlag.setImageResource(R.drawable.channel_bbt_header_flag);
        ImageView headerPortrait = (ImageView) contentView.findViewById(R.id.channel_header_portrait);
        headerPortrait.setVisibility(View.GONE);
    }
