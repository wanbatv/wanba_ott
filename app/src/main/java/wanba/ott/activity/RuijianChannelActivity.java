 ...
 */
public class RuijianChannelActivity extends BaseChannelActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackground(getResources().getDrawable(R.drawable.channel_ruijian_background));
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                new OpenActivityAction(RuijianChannelActivity.this,
        ...
        final JsonObjectRequest request = new JsonObjectRequest(
                "http://121.201.7.173:8080/wanba_shzg/ott_channel_ruijian.jsp",
                null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            ProductInfo.Product p = ProductInfo.getInstance().getProductWithId("1");
                            for (int i = 0; i < n; i++) {
    ...
    protected void onBuildHeader(ViewGroup contentView) {
        ...
        headerFlag.setImageResource(R.drawable.channel_ruijian_header_flag);
        ImageView headerPortrait = (ImageView) contentView.findViewById(R.id.channel_header_portrait);
        headerPortrait.setImageResource(R.drawable.channel_ruijian_header_portrait);
    }
