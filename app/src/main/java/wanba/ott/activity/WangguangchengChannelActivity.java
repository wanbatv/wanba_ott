 ...
 */
public class WangguangchengChannelActivity extends BaseChannelActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackground(getResources().getDrawable(R.drawable.channel_wgc_background));
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                new OpenActivityAction(WangguangchengChannelActivity.this,
        ...
        final JsonObjectRequest request = new JsonObjectRequest(
                "http://121.201.7.173:8080/wanba_shzg/ott_channel_wgc.jsp",
                null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            ProductInfo.Product p = ProductInfo.getInstance().getProductWithId("2");
                            for (int i = 0; i < n; i++) {
    ...
    protected void onBuildHeader(ViewGroup contentView) {
        ...
        headerFlag.setImageResource(R.drawable.channel_wgc_header_flag);
        ImageView headerPortrait = (ImageView) contentView.findViewById(R.id.channel_header_portrait);
        headerPortrait.setImageResource(R.drawable.channel_wgc_header_portrait);
    }
