 ...
 */
public class JianshencaoChannelActivity extends BaseChannelActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackground(getResources().getDrawable(R.drawable.channel_jsc_background));
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                new OpenActivityAction(JianshencaoChannelActivity.this,
        ...
        final JsonObjectRequest request = new JsonObjectRequest(
                "http://121.201.7.173:8080/wanba_shzg/ott_channel_yoga.jsp",
                null,
    ...
    protected void onBuildHeader(ViewGroup contentView) {
        ...
        headerFlag.setImageResource(R.drawable.channel_jsc_header_flag);
        ImageView headerPortrait = (ImageView) contentView.findViewById(R.id.channel_header_portrait);
        headerPortrait.setImageResource(R.drawable.channel_jsc_header_portrait);
    }
