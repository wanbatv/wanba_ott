 ...
 */
public class DupiwuChannelActivity extends BaseChannelActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackground(getResources().getDrawable(R.drawable.channel_dpw_background));
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                new OpenActivityAction(DupiwuChannelActivity.this,
        ...
        final JsonObjectRequest request = new JsonObjectRequest(
                "http://121.201.7.173:8080/wanba_shzg/ott_channel_dupiwu.jsp",
                null,
    ...
    protected void onBuildHeader(ViewGroup contentView) {
        ...
        headerFlag.setImageResource(R.drawable.channel_dpw_header_flag);
        ImageView headerPortrait = (ImageView) contentView.findViewById(R.id.channel_header_portrait);
        headerPortrait.setImageResource(R.drawable.channel_dpw_header_portrait);
    }
